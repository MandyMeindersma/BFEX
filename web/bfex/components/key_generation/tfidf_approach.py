...
class TfidfApproach(KeyGenerationApproach):
    ...
    def generate_keywords(self, text):
        ...
        lanes_nono_words = ["research","interests","interested","1","2","3","4","5","6","7","8","9","0"]
        ...
        for word in single_words:
            if word not in stop_words and word not in lanes_nono_words:
        ...
        for bigram in bigrams:
            if (bigram[0] not in stop_words) and (bigram[1] not in stop_words)\
                and (bigram[0] not in lanes_nono_words) and (bigram[1] not in lanes_nono_words):
        ...
        for trigram in trigrams:
            if (trigram[0] not in stop_words) and (trigram[1] not in stop_words)\
             and (trigram[2] not in stop_words) and (trigram[0] not in lanes_nono_words) \
             and (trigram[1] not in lanes_nono_words) and (trigram[2] not in lanes_nono_words):
...
if __name__ == "__main__":
    ...
    search = Document.search().query('match', faculty_id= "370") \
